...
**Physics at University College London · Applied mathematics · Scientific computing**

I am a physics student at UCL, interested in differential equations, numerical modelling and the interpretation of experimental data. My work connects physical models with computation, with particular attention to uncertainty and the reliability of numerical predictions.
...
| --- | --- |
| Programming and data analysis | Python: NumPy, SciPy, pandas, Matplotlib; MATLAB |
| Scientific computing | OpenFOAM; ParaView |
| Mathematical methods | Differential equations; Fourier methods; regression; uncertainty propagation; residual analysis |
| Technical writing and development | LaTeX; Git and C/C++ at a basic level |

## Academic interests

I am particularly interested in numerical methods for partial differential equations, wave propagation and the mathematical assumptions behind physical models. I would like to develop a deeper understanding of how discretisation and measurement uncertainty affect the conclusions drawn from a calculation.
